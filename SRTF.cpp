...
#include <iostream>
using namespace std;
struct compareByTimeLeft
{
    bool operator()(const Process& a, const Process& b) const
    {
        return a.executionTimeLeft > b.executionTimeLeft;
    }
};

Result SRTF::calculate(std::vector<Process> processes)
{
    ...
    std::priority_queue<Process, std::vector<Process>, compareByTimeLeft> readyQueue;
    int pt = 0;
